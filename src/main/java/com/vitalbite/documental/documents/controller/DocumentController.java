...
public class DocumentController {
    ...
    @Operation(
            ...
            description = "Recibe datos de dieta desde el Core NestJS, " +
    ...
    public ResponseEntity<DocumentResponseDTO> generateDietPdf(
        ...
        DocumentResponseDTO response = documentService.generateDietPdf(request);
    ...
    @Operation(
            ...
            description = "Recibe datos de pago desde el microservicio .NET y " +
                    "genera una factura en PDF con el Hash de la Blockchain"
    )
    ...
    @PostMapping(value = "/pdf/diet/preview", produces = "application/pdf")
    @Operation(
            summary = "Preview del PDF de dieta",
            description = "Genera y devuelve el PDF directamente en el navegador " +
                    "para revisar el diseño. Solo para desarrollo, no guarda nada en base de datos."
    )
    public ResponseEntity<byte[]> previewDietPdf(
        ...
        return ResponseEntity.ok()
                .header("Content-Disposition", "inline; filename=preview-dieta.pdf")
                .body(pdfBytes);
    }
    ...
    @Operation(
            ...
            description = "Verifica que el módulo de documentos está activo"
    )
    public ResponseEntity<String> health() {
        return ResponseEntity.ok("Módulo documental funcionando correctamente");
    }

    @GetMapping("/patient/{patientId}")
    @Operation(
            summary = "Listar documentos por paciente",
            description = "Devuelve una lista de los documentos generados para el paciente"
    )
    public ResponseEntity<List<DocumentMetadata>> getDocumentsByPatient(
